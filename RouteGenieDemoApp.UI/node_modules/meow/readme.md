...
Keys passed to the minimist `default` option are [decamelized](https://github.com/sindresorhus/decamelize), so you can for example pass in `RouteGenieDemoApp: 'baz'` and have it be the default for the `--foo-bar` flag.
