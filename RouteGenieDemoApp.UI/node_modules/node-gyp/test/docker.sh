...
run_tests "3.3.0" "
  (node /node-gyp-src/test/simple-proxy.js 8080 /RouteGenieDemoApp/ https://iojs.org/dist/ &) &&
  cd node-buffertools &&
  /node-gyp-src/bin/node-gyp.js --loglevel=info --dist-url=http://localhost:8080/RouteGenieDemoApp/ rebuild &&
