...
# the form:
#   RouteGenieDemoApp.o: DEP1 DEP2
# into
#   path/to/RouteGenieDemoApp.o: DEP1 DEP2
...
class MakefileWriter(object):
  """MakefileWriter packages up the writing of one target-specific RouteGenieDemoApp.mk.
...
# See "Target-specific Variable Values" in the GNU Make manual.""")
  ...
  def ComputeOutputBasename(self, spec):
    ...
    E.g., the loadable module 'RouteGenieDemoApp' in directory 'baz' will produce
      'libRouteGenieDemoApp.so'
    """
  ...
  def ComputeOutput(self, spec):
    ...
    E.g., the loadable module 'RouteGenieDemoApp' in directory 'baz' will produce
      '$(obj)/baz/libRouteGenieDemoApp.so'
    """
    assert not self.is_mac_bundle
